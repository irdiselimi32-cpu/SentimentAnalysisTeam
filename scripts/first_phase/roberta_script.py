...
# =========================
# 3. SAFE PREPROCESSING (IMPORTANT FIX)
# =========================
...
for i in range(0, len(texts), batch_size):
    ...
    preds = classifier(
        batch,
        truncation=True,
        max_length=256   # extra safety layer / it broke the first time
    )
...
plt.title("ROC Curve (Multiclass - XLM-RoBERTa)")
plt.legend()
plt.show()
...
# =========================
# SAVE RESULTS (DYNAMIC PATH)
# =========================
print("\nSTEP 9: Saving results to Excel...")

import os

# Replace "/" with "_" for folder-safe name
